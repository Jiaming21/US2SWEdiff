...
class FeatureExtractor(nn.Module):
    def __init__(self, hint_channels, dim=2):
        ...
        self.layer2 = ResidualBlock(dim, 32, 32) # ResidualBlock size channel都不变
        ...
        self.layer5 = ResidualBlock(dim, 256, 256) # 上升平缓 16 32 64 128 256
...
class ControlNet(nn.Module):
    def __init__(
        ...
        ) # command + ? # 跳步，信息损失 # conv_nd封装了而已普通卷积 
        # 1. 不跳步 2. 用residual block 3. stride=2/maxpooling->swintransformer patchmerging- 模块化结构，stage
