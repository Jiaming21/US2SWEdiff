#!/usr/bin/env python3
"""
Plot all metrics for Dispersive Loss Location from results/dispersive_all_metrics.csv.

Supports upto_0 .. upto_13 (and other w). X-axis sorted by (w, upto_k).
...
def model_order(model_id: str) -> tuple:
    """Sort by (w, upto_k): upto_0..13_w0.05 first, then other w (e.g. upto_1_w0.1)."""
    import re
...
def main():
    ...
    fig.suptitle("Dispersive Loss Location: All Metrics", fontsize=12)
    plt.tight_layout()
