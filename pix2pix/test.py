...
if __name__ == "__main__":
    ...
    # create a website
    results_subpath = opt.results_name if opt.results_name else opt.name
    if opt.results_flat:
        web_dir = Path(opt.results_dir) / results_subpath
    else:
        web_dir = Path(opt.results_dir) / results_subpath / f"{opt.phase}_{opt.epoch}"
