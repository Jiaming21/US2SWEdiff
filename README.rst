...
* `Inference <#inference>`_
	...
	* `Option 1: Using Gradio Interface <#option-1-using-gradio-interface>`_
        ...
        * `Option 2: Using Provided Scripts <#option-2-using-provided-scripts>`_
    		...
    		* `Step 1–3: Repeat Previous Instructions <#step-1-to-3-repeat-previous-instructions>`_
...
* `Train <#train>`_
  ...
  * `Step 1–2: Prepare Conda Environment & Pull from GitHub Repository <#step-1-to-2-prepare-conda-environment-pull-from-github-repository>`_
  * `Step 3: Prepare the Dataset <#step-3-prepare-the-dataset>`_
...
.. _step-1-to-3-repeat-previous-instructions:
...
.. _step-1-to-2-prepare-conda-environment-pull-from-github-repository:
