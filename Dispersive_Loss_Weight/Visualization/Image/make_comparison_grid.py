...
METHODS = [
    ...
    (
        "w0.01",
        Path(
            "/n/holylfs05/LABS/zhuang_lab/Lab/Jiaming/Dispersive_Loss_Weight/MDHI_dispersive_upto_8_w0.01/images/test/images"
        ),
        None,
    ),
    (
        "w0.03",
        Path(
            "/n/holylfs05/LABS/zhuang_lab/Lab/Jiaming/Dispersive_Loss_Weight/MDHI_dispersive_upto_8_w0.03/images/test/images"
        ),
        None,
    ),
    (
        "w0.05",
        Path(
            "/n/holylfs05/LABS/zhuang_lab/Lab/Jiaming/Dispersive_Loss_Weight/MDHI_dispersive_upto_8_w0.05/images/test/images"
        ),
        None,
    ),
    (
        "w0.07",
        Path(
            "/n/holylfs05/LABS/zhuang_lab/Lab/Jiaming/Dispersive_Loss_Weight/MDHI_dispersive_upto_8_w0.07/images/test/images"
        ),
        None,
    ),
    (
        "w0.09",
        Path(
            "/n/holylfs05/LABS/zhuang_lab/Lab/Jiaming/Dispersive_Loss_Weight/MDHI_dispersive_upto_8_w0.09/images/test/images"
        ),
        None,
    ),
]
...
def main() -> None:
    ...
    if min_count != max_count:
        raise RuntimeError(
            f"Image count mismatch across columns: min={min_count}, max={max_count}. "
            "Please ensure Real SWE, Laplacian, and all weight folders have the same number of images."
        )
