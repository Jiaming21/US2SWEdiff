...
# Run the processing
input_dir = "/root/autodl-tmp/ControlNet-main/data/BreastCA-img/train/all/swe_256/"
output_dir = "/root/autodl-tmp/ControlNet-main/data/BreastCA-img/train/all/clip_prompt"
