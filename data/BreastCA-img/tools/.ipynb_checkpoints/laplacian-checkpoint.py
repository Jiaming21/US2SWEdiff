...
# sketch_dir = '/root/autodl-tmp/ControlNet-main/data/BreastCA-img/train/laplacian'
# create_edge_maps(input_dir, sketch_dir)
# 
# input_dir = '/root/autodl-tmp/ControlNet-main/data/BreastCA-img/test/us'
# sketch_dir = '/root/autodl-tmp/ControlNet-main/data/BreastCA-img/test/laplacian'
# create_edge_maps(input_dir, sketch_dir)

input_dir = '/root/autodl-tmp/ControlNet-main/data/BreastCA-img/infer/BUSBRA/us'
sketch_dir = '/root/autodl-tmp/ControlNet-main/data/BreastCA-img/infer/BUSBRA/laplacian'
create_edge_maps(input_dir, sketch_dir)
